...
REF=/lustre/scratch/jiamiao/tevarsim/data/hg38.fa
# map
bwa mem -t 16 ${REF} read_R1.fq.gz read_R2.fq.gz | samtools sort -o sorted.bam
samtools index sorted.bam
EOF
...
cd /lustre/scratch/jiamiao/tevarsim/long

minimap2 -aYx map-ont -t 16 /lustre/scratch/jiamiao/tevarsim/data/hg38.fa \
 /lustre/scratch/jiamiao/tevarsim/long/reads.fq.gz | samtools view -bhS - | samtools sort -o sorted.bam - 
...
REF=/lustre/scratch/jiamiao/tevarsim/data/hg38.fa
MELT_JAR=/home/jiamiao/software/MELTv2.2.2/MELT.jar
# preprocess
java -jar ${MELT_JAR} Preprocess -h ${REF} -bamfile sorted.bam
# single sample
ls /home/jiamiao/software/MELTv2.2.2/me_refs/Hg38/*zip > meltTransposonFileList.txt 
java -jar ${MELT_JAR} Single \
-h ${REF} \
-bamfile sorted.bam \
-n /home/jiamiao/software/MELTv2.2.2/add_bed_files/Hg38/Hg38.genes.bed \
-c 10 -t meltTransposonFileList.txt -w melt
EOF
